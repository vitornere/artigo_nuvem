...
\title{Uma Proposta de Arquitetura Autonômica para Elasticidade em Computação em Nuvem}
...
\begin{resumo}
  O objetivo deste artigo é abordar o conhecimento construido no artigo "Uma Proposta de Arquitetura Autonômica para Elasticidade em Computação em Nuvem", utilizando-se de outros artefatos e ferramentas para verificar os experimentos consolidados pelo mesmo artigo, com o intuito de adquirir um maior conhecimento na área e na disciplina de Computação em Nuvem da Universidade de Brasília.
