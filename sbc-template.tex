...
\begin{abstract}
  The purpose of this article is to address the knowledge built in Article \cite{coutinho_et_al:14}, using other artifacts and tools to check the experiments consolidated by the same article, in order to acquire greater knowledge in the field and discipline Cloud Computing at the University of Brasilia, campus Gama.
\end{abstract}
